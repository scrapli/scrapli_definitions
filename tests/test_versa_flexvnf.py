...
PROMPTS = (
    (
        "simple",
        "shell",
        "[admin@generic-hostname: ~] $ ",
    ),
    (
        "workdir",
        "shell",
        "[admin@generic-hostname: tmp] $ ",
    ),
    (
        "simple",
        "cli",
        "admin@generic-hostname-cli> ",
    ),
    (
        "simple",
        "configuration",
        "admin@generic-hostname-cli(config)% ",
    ),
    (
        "interface",
        "configuration",
        "admin@generic-hostname-cli(config-interfaces)% ",
    ),
)
